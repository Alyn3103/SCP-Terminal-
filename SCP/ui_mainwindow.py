...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Search.setStyleSheet("QLineEdit {\n"
                                  "    background-color: rgba(48, 48, 48, 0.2); /* Black background */\n"  # Change background color to black
                                  "    border: 2px solid #555555;\n"
                                  "    border-radius: 10px;\n"
                                  "    padding: 5px;\n"
                                  "    color: #CCCCCC; /* Light gray text color */\n"  # Adjust text color for better contrast
                                  "    font-size: 14pt;\n"
                                  "    selection-background-color: #a4c21;\n"
                                  "    box-shadow: 0 0 0 2px white inset;\n"
                                  "    selection-color: #FFFFFF;\n"
                                  "}\n"
                                  "\n"
                                  "QLineEdit:focus {\n"
                                  "    border: 2px solid #AAAAAA;\n"  # Optional: Adjust focus border color
                                  "}")
        ...
        self.Searchbutton.setStyleSheet("QPushButton {\n"
                                        "    background-color: #800000; /* Dark gray background */\n"  # Adjust background color
                                        "    border: 2px solid #555555;\n"
                                        "    border-radius: 10px;\n"
                                        "    border-color: #2a4c21;\n"
        ...
        def adjustFontSize(label):
            font = label.font()
            fontSize = font.pointSize()
            while label.fontMetrics().boundingRect(label.text()).width() > label.width() and fontSize > 1:
                fontSize -= 1
                font.setPointSize(fontSize)
                label.setFont(font)
            label.setFont(font)

        adjustFontSize(self.Detail)
        self.Detail.setScaledContents(True)
        self.Detail.setObjectName("Detail")

        self.Detail.setWordWrap(True)  # enable word wrapping
        self.Detail.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
